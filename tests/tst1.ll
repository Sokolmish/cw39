...
block_3:                                          ; preds = %block_2, %block_1
  %vr145 = phi i32 [ %.arg_1, %block_1 ], [ %.arg_0, %block_2 ]
...
block_8:                                          ; preds = %block_7, %block_6
  %vr147 = phi i32 [ %vr24, %block_6 ], [ %vr30, %block_7 ]
...
block_9:                                          ; preds = %block_10, %block_8
  %vr153 = phi i32 [ 10, %block_8 ], [ %vr81, %block_10 ]
...
block_12:                                         ; preds = %block_13, %block_11
  %vr154.1 = phi i32 [ 0, %block_11 ], [ %vr97, %block_13 ]
  %vr85 = icmp slt i32 %vr154.1, 4
  br i1 %vr85, label %block_13, label %block_14
...
block_15:                                         ; preds = %block_18, %block_14
  %vr155 = phi i32 [ 0, %block_14 ], [ %vr102, %block_18 ]
  %vr100 = icmp slt i32 %vr155, 4
  br i1 %vr100, label %block_16, label %block_17
...
block_19:                                         ; preds = %block_20, %block_17
  %vr154.4 = phi i32 [ 3, %block_17 ], [ %vr114, %block_20 ]
  br label %block_20
...
block_20:                                         ; preds = %block_19
  ...
  br i1 %vr118, label %block_21, label %block_19
...
block_25:                                         ; preds = %block_24, %block_21
  %vr126.0 = phi i32 [ undef, %block_21 ], [ %vr126.2, %block_24 ]
  %vr127.0 = phi i32 [ undef, %block_21 ], [ %vr127.2, %block_24 ]
  %vr154.8 = phi i32 [ 0, %block_21 ], [ %vr154.11, %block_24 ]
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str4, i32 0, i32 0), i32 %vr154.8)
  %vr125 = icmp eq i32 %vr154.8, 0
  br i1 %vr125, label %block_27, label %block_28
...
block_29:                                         ; preds = %block_28, %block_27
  %vr126.2 = phi i32 [ %vr126.0, %block_27 ], [ %vr154.8, %block_28 ]
  %vr127.2 = phi i32 [ %vr127.0, %block_27 ], [ %vr127.1, %block_28 ]
  %vr154.11 = phi i32 [ 2, %block_27 ], [ %vr127.1, %block_28 ]
  br label %block_24

block_24:                                         ; preds = %block_29
  %vr121 = icmp ne i32 %vr154.11, 0
  br i1 %vr121, label %block_25, label %block_26
...
block_30:                                         ; preds = %block_33, %block_26
  %vr156 = phi i32 [ 0, %block_26 ], [ %vr131, %block_33 ]
  br label %block_31
...
block_31:                                         ; preds = %block_30
  ...
  br i1 %vr135, label %block_32, label %block_33
